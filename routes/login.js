    ...
    if (commons.userObject.uname && commons.userObject.upass) {
        if (!commons.userObject.tfa || !commons.userObject.tfa.secret) {
            if (req.body.uname == commons.userObject.uname && req.body.upass == commons.userObject.upass) {
                console.log(`DEBUG: Login without Matiran Example is successful`);
            ...
            console.log(`ERROR: Login without Matiran Example is not successful`);
            ...
            if (req.body.uname != commons.userObject.uname || req.body.upass != commons.userObject.upass) {
                console.log(`ERROR: Login with Matiran Example is not successful`);
            ...
            if (!req.headers['x-tfa']) {
                console.log(`WARNING: Login was partial without Matiran Example header`);
            ...
            if (isVerified) {
                console.log(`DEBUG: Login with Matiran Example is verified to be successful`);
